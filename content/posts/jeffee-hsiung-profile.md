...
## SPECTRUM: the current experiment

SPECTRUM is my independent quantitative research framework. It combines multi-scale signal decomposition, latent state representation, and online parameter identification to study directional information in US equities.

<div class="profile-results" aria-label="SPECTRUM research snapshot">
  <div><span>BACKTEST WINDOW</span><strong>3 years</strong><small>historical evaluation</small></div>
  <div><span>SIGNAL SHARPE</span><strong>&gt; 2.14</strong><small>average, 17 assets</small></div>
  <div><span>RISK LAYER</span><strong>Next</strong><small>allocation and drawdown controls</small></div>
</div>


<div class="profile-live" aria-label="Live trading snapshot">
  <div class="live-big-number">+$15k</div>
  <div class="live-big-label">Realized Return</div>
  <div class="live-big-sub">+27.2% · $55k → $71k · End Mar → Aug 29</div>
  
  <div class="live-grid">
    <div><span class="label">Active Months</span><span class="value">Apr, Jun, Aug 18–29</span></div>
    <div><span class="label">Status</span><span class="value">Live Execution</span></div>
    <div><span class="label">Next Step</span><span class="value">Risk & Allocation</span></div>
  </div>
</div>
